...
class Ek4gDocx:
    """
    EK-4/G listesi için madde bazlı chunker.
...
def chunk(filename, binary=None, from_page=0, to_page=100000,
    ...
    EK-4/G listesi için madde bazlı chunking.
    Her madde ayrı bir chunk olarak üretilir.
    """
    ...
    if re.search(r"\.docx$", filename, re.IGNORECASE):
        callback(0.1, "EK-4G isleniyor (madde bazli chunking)...")
        rawChunks = Ek4gDocx()(filename, binary, from_page, to_page)
        callback(0.7, "EK-4G chunking tamamlandi.")
        ...
        raise NotImplementedError("EK-4G chunker sadece .docx dosyalarini destekler")
