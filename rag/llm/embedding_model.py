    ...
    def encode(self, texts: list):
        ...
        for i in range(0, len(texts), batch_size):
            ...
            try:
                ...
                logger.exception("DiagnosisGenieEmbed: failed to parse embedding response")
                raise EmbeddingError(f"Embedding request failed for DiagnosisGenieEmbed. Error: {_e}; response={response.text}") from _e
