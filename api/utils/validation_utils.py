...
class UpdateDocumentReq(Base):
    ...
    def validate_document_chunk_method(cls, chunk_method: str | None):
        ...
        if chunk_method:
            ...
            valid_chunk_method = {"naive", "manual", "qa", "table", "paper", "book", "laws", "presentation", "picture", "one", "knowledge_graph", "email", "tag", "audio", "sut", "table_sut", "fi_sut", "sut_teblig", "ek4g", "ek4f", "sut_sgk", "resume", "hastakabulchunker"}
...
class CreateDatasetReq(Base):
    ...
    def validate_chunk_method(cls, v: Any, handler, info: ValidationInfo) -> Any:
        ...
        allowed = {"naive", "book", "email", "laws", "manual", "one", "paper", "picture", "presentation", "qa", "table", "tag", "resume", "audio", "knowledge_graph", "sut", "table_sut", "fi_sut", "sut_teblig", "ek4g", "ek4f", "sut_sgk", "hastakabulchunker"}
        error_msg = "Input should be 'naive', 'book', 'email', 'laws', 'manual', 'one', 'paper', 'picture', 'presentation', 'qa', 'table', 'tag', 'resume', 'audio', 'knowledge_graph', 'sut', 'table_sut', 'fi_sut', 'sut_teblig', 'ek4g', 'ek4f', 'sut_sgk' or 'hastakabulchunker'"
        try:
