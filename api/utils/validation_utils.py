...
class UpdateDocumentReq(Base):
    ...
    def validate_document_chunk_method(cls, chunk_method: str | None):
        ...
        if chunk_method:
            ...
            valid_chunk_method = {"naive", "manual", "qa", "table", "paper", "book", "laws", "presentation", "picture", "one", "knowledge_graph", "email", "tag", "sut", "table_sut", "fi_sut", "sut_teblig", "ek4g", "ek4f", "sut_sgk", "resume", "hastakabulchunker"}
