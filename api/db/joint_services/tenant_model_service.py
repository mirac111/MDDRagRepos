...
def get_model_config_from_provider_instance(tenant_id, model_type: str|enum.Enum, model_name: str):
    ...
    if model_obj:
        ...
        model_extra = json.loads(model_obj.extra) if model_obj.extra else {}  # FIX: model_obj.extra'dan max_tokens oku
        model_config = {
            ...
            "max_tokens": model_extra.get("max_tokens", 8192),  # FIX: eklendi
        }
        ...
        model_config = {
            ...
            "max_tokens": llm_info.get("max_tokens", 8192),  # FIX: eklendi
        }
        if api_key_payload is not None:
            model_config["api_key_payload"] = api_key_payload
        return model_config
